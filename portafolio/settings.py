...
# Carpeta para templates compartidos
...
# Whitenoise: comprime y cachea archivos estáticos en producción
STORAGES = {
    "default": {
...
# Archivos subidos por usuarios (fotos de proyectos, etc.)
MEDIA_URL = 'media/'
...
EMAIL_DESTINATARIO = config('EMAIL_HOST_USER')
